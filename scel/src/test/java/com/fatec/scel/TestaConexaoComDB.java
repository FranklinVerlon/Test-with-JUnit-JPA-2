...
// verificacao
			...
			//primeiro parametro é o resultado esperado e o segundo é o resultado obtido
			assertEquals("java.sql.SQLException: Access denied for user 'root'@'localhost' (using password: YES)", e.getMessage());
		}
	}
}